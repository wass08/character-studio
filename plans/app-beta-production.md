...
| 3 | Engine rewrite — TS + WebGPU/TSL coupled | [app-engine-rewrite](app-engine-rewrite.md) | p1 | in_progress | — | Phase 0 (design) shipped. Phase 1a + 2a (TS conversion of Backdrop, lipsync.js, LipsyncDriver) shipped — TS toolchain proven. Phases 1b/2b–8b (TSL/WebGPU layer) reserved for the hardware-verification session. |
