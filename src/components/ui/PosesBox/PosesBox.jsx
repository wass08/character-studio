...
const PosesBox = () => {
  ...
  return (
    <div className="glass-panel no-scrollbar absolute bottom-5 left-1/2 z-30 flex max-w-[90vw] -translate-x-1/2 flex-row items-center gap-1.5 overflow-x-auto rounded-2xl p-2">
        ...
        return (
          <Tooltip key={label} label={label} side="top">
            <motion.button
              ...
              className={`relative inline-flex shrink-0 items-center justify-center rounded-xl px-4 py-2 text-xs font-medium tracking-tight transition-colors ${
